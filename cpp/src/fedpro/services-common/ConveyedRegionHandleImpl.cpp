...
{
   HandleImplementation * ConveyedRegionHandleImpl::clone() const
   {
      return new ConveyedRegionHandleImpl(*this);
   }

   void ConveyedRegionHandleImpl::addRange(
   ...
   RangeBounds ConveyedRegionHandleImpl::getRangeBounds(const DimensionHandle & dimensionHandle) const
   {
   ...
   DimensionHandleSet ConveyedRegionHandleImpl::getDimensionHandleSet() const
   {
