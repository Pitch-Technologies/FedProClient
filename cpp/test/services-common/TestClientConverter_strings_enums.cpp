...
{                                                                    \
   analyze_enum<rti1516_2025::fedpro::EnumType>(                     \
      rti1516_2025::fedpro::EnumType##_descriptor());                \
                                                                     \
   test_enum_values_unique();                                        \
   test_enum_invalid_value_conversion<rti1516_2025::fedpro::EnumType>(); \
}
...
{                                                                    \
   ...
   test_enum_values_unique();                                        \
   test_enum_invalid_value_conversion<rti1516_2025::fedpro::EnumType>(); \
   test_enum_back_and_forth_conversion<rti1516_2025::fedpro::EnumType>(); \
}
