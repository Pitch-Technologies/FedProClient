...
{
   test_convertToHla<rti1516_2025::fedpro::ConfigurationResult>();
}

TEST_F(TestClientConverterObjects, FederationExecutionInformation)
{
   test_convertToHla<rti1516_2025::fedpro::FederationExecutionInformation>();
}

TEST_F(TestClientConverterObjects, FederationExecutionMemberInformation)
{
   test_convertToHla<rti1516_2025::fedpro::FederationExecutionMemberInformation>();
}

TEST_F(TestClientConverterObjects, FederateRestoreStatus)
{
   test_convertToHla<rti1516_2025::fedpro::FederateRestoreStatus>();
}
