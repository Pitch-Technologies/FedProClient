...
// Run relevant responses test functions for rti1516_202X::fedpro::JoinFederationExecutionResponse.
template<>
void TestClientConverterResponses::test_response<rti1516_202X::fedpro::JoinFederationExecutionResponse>()
{
   test_convertTo_empty_response<rti1516_202X::fedpro::JoinFederationExecutionResponse>();
...
// Run relevant responses test functions for rti1516_202X::fedpro::QueryGALTResponse.
template<>
void TestClientConverterResponses::test_response<rti1516_202X::fedpro::QueryGALTResponse>()
{
   test_convertTo_empty_response<rti1516_202X::fedpro::QueryGALTResponse>();

   // There is only a one-way conversion for rti1516_202X::fedpro::TimeQueryReturn
   // So this specialization call test_convertToHla instead of test_convertFrom_convertTo.
...
// Run relevant responses test functions for rti1516_202X::fedpro::QueryLogicalTimeResponse.
template<>
void TestClientConverterResponses::test_response<rti1516_202X::fedpro::QueryLogicalTimeResponse>()
{
   test_convertTo_empty_response<rti1516_202X::fedpro::QueryLogicalTimeResponse>();

   // Test one-way conversion for rti1516_202X::fedpro::LogicalTime using float time.
   _clientConverter.setTimeFactory(std::make_shared<RTI_NAMESPACE::HLAfloat64TimeFactory>());
   test_convertToHla<rti1516_202X::fedpro::LogicalTime>();

   // Test one-way conversion for rti1516_202X::fedpro::LogicalTime using integer time.
   _clientConverter.setTimeFactory(std::make_shared<RTI_NAMESPACE::HLAinteger64TimeFactory>());
   test_convertToHla<rti1516_202X::fedpro::LogicalTime>();
}

// Run relevant responses test functions for rti1516_202X::fedpro::QueryLITSResponse.
template<>
void TestClientConverterResponses::test_response<rti1516_202X::fedpro::QueryLITSResponse>()
{
   test_convertTo_empty_response<rti1516_202X::fedpro::QueryLITSResponse>();
...
// Run relevant responses test functions for rti1516_202X::fedpro::QueryLookaheadResponse.
...
template<>
void TestClientConverterResponses::test_response<rti1516_202X::fedpro::QueryLookaheadResponse>()
{
   test_convertTo_empty_response<rti1516_202X::fedpro::QueryLookaheadResponse>();
}

TEST_F(TestClientConverterResponses, JoinFederationExecutionResponse)
{
   test_response<rti1516_202X::fedpro::JoinFederationExecutionResponse>();
}

TEST_F(TestClientConverterResponses, IsAttributeOwnedByFederateResponse)
{
   test_response<rti1516_202X::fedpro::IsAttributeOwnedByFederateResponse>();
}

TEST_F(TestClientConverterResponses, RegisterObjectInstanceWithNameResponse)
{
   test_response<rti1516_202X::fedpro::RegisterObjectInstanceWithNameResponse>();
}

TEST_F(TestClientConverterResponses, UpdateAttributeValuesWithTimeResponse)
{
   test_response<rti1516_202X::fedpro::UpdateAttributeValuesWithTimeResponse>();
}

TEST_F(TestClientConverterResponses, RegisterObjectInstanceResponse)
{
   test_response<rti1516_202X::fedpro::RegisterObjectInstanceResponse>();
}

TEST_F(TestClientConverterResponses, SendInteractionWithTimeResponse)
{
   test_response<rti1516_202X::fedpro::SendInteractionWithTimeResponse>();
}

TEST_F(TestClientConverterResponses, SendDirectedInteractionWithTimeResponse)
{
   test_response<rti1516_202X::fedpro::SendDirectedInteractionWithTimeResponse>();
}

TEST_F(TestClientConverterResponses, DeleteObjectInstanceWithTimeResponse)
{
   test_response<rti1516_202X::fedpro::DeleteObjectInstanceWithTimeResponse>();
}

TEST_F(TestClientConverterResponses, AttributeOwnershipDivestitureIfWantedResponse)
{
   test_response<rti1516_202X::fedpro::AttributeOwnershipDivestitureIfWantedResponse>();
}

TEST_F(TestClientConverterResponses, QueryGALTResponse)
{
   test_response<rti1516_202X::fedpro::QueryGALTResponse>();
}

TEST_F(TestClientConverterResponses, QueryLogicalTimeResponse)
{
   test_response<rti1516_202X::fedpro::QueryLogicalTimeResponse>();
}

TEST_F(TestClientConverterResponses, QueryLITSResponse)
{
   test_response<rti1516_202X::fedpro::QueryLITSResponse>();
}

TEST_F(TestClientConverterResponses, QueryLookaheadResponse)
{
   test_response<rti1516_202X::fedpro::QueryLookaheadResponse>();
}

TEST_F(TestClientConverterResponses, CreateRegionResponse)
{
   test_response<rti1516_202X::fedpro::CreateRegionResponse>();
}

TEST_F(TestClientConverterResponses, RegisterObjectInstanceWithRegionsResponse)
{
   test_response<rti1516_202X::fedpro::RegisterObjectInstanceWithRegionsResponse>();
}

TEST_F(TestClientConverterResponses, RegisterObjectInstanceWithNameAndRegionsResponse)
{
   test_response<rti1516_202X::fedpro::RegisterObjectInstanceWithNameAndRegionsResponse>();
}

TEST_F(TestClientConverterResponses, SendInteractionWithRegionsAndTimeResponse)
{
   test_response<rti1516_202X::fedpro::SendInteractionWithRegionsAndTimeResponse>();
}

TEST_F(TestClientConverterResponses, GetAutomaticResignDirectiveResponse)
{
   test_response<rti1516_202X::fedpro::GetAutomaticResignDirectiveResponse>();
}

TEST_F(TestClientConverterResponses, GetAvailableDimensionsForObjectClassResponse)
{
   test_response<rti1516_202X::fedpro::GetAvailableDimensionsForObjectClassResponse>();
}

TEST_F(TestClientConverterResponses, GetFederateHandleResponse)
{
   test_response<rti1516_202X::fedpro::GetFederateHandleResponse>();
}

TEST_F(TestClientConverterResponses, GetFederateNameResponse)
{
   test_response<rti1516_202X::fedpro::GetFederateNameResponse>();
}

TEST_F(TestClientConverterResponses, GetObjectClassHandleResponse)
{
   test_response<rti1516_202X::fedpro::GetObjectClassHandleResponse>();
}
