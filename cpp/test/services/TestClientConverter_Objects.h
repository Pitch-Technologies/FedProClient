...
// Create valid a instance of rti1516_202X::fedpro::FederateRestoreStatus.
template<>
inline auto TestClientConverter::createValidInstances<rti1516_202X::fedpro::FederateRestoreStatus>() const
{
   rti1516_202X::fedpro::FederateRestoreStatus federateRestoreStatus;
   federateRestoreStatus.set_allocated_prerestorehandle(new rti1516_202X::fedpro::FederateHandle);
   federateRestoreStatus.set_allocated_postrestorehandle(new rti1516_202X::fedpro::FederateHandle);
   federateRestoreStatus.set_restorestatus(rti1516_202X::fedpro::FEDERATE_RESTORING);
   return std::array<rti1516_202X::fedpro::FederateRestoreStatus, 1>{federateRestoreStatus};
}

// Create a valid instance of rti1516_202X::fedpro::JoinResult.
template<>
inline auto TestClientConverter::createValidInstances<rti1516_202X::fedpro::JoinResult>() const
{
   rti1516_202X::fedpro::JoinResult fedproJoinResult;
   fedproJoinResult.set_allocated_federatehandle(new rti1516_202X::fedpro::FederateHandle);
   return std::array<rti1516_202X::fedpro::JoinResult, 1>{fedproJoinResult};
}

// Create an invalid instance of rti1516_202X::fedpro::JoinResult.
template<>
inline auto TestClientConverter::createInvalidInstances<rti1516_202X::fedpro::JoinResult>() const
{
   rti1516_202X::fedpro::JoinResult fedproJoinResultMissingField;
   return std::array<rti1516_202X::fedpro::JoinResult, 1>{fedproJoinResultMissingField};
}
...
// Create valid instances of rti1516_202X::fedpro::TimeQueryReturn.
template<>
inline auto TestClientConverter::createValidInstances<rti1516_202X::fedpro::TimeQueryReturn>() const
{
   std::vector<rti1516_202X::fedpro::TimeQueryReturn> timeQueryReturnVector;
   auto rtiValidTimes = createValidInstances<RTI_NAMESPACE::HLAfloat64Time>();
   for (const auto & rtiValidTime : rtiValidTimes) {
      rti1516_202X::fedpro::TimeQueryReturn timeQueryReturn;
...
// Create valid instances of rti1516_202X::fedpro::LogicalTime.
template<>
inline auto TestClientConverter::createValidInstances<rti1516_202X::fedpro::LogicalTime>() const
{
   auto timeFactory = _clientConverter.getTimeFactory();
   auto initialTime = timeFactory->makeInitial();
   std::unique_ptr<rti1516_202X::fedpro::LogicalTime> fedproInitialTime{ _clientConverter.convertFromHla(*initialTime)};
   auto finalTime = timeFactory->makeFinal();
   std::unique_ptr<rti1516_202X::fedpro::LogicalTime> fedproFinalTime{ _clientConverter.convertFromHla(*finalTime)};
   return std::array<rti1516_202X::fedpro::LogicalTime, 2>{*fedproInitialTime, *fedproFinalTime};
}

// Create invalid instances of rti1516_202X::fedpro::LogicalTime.
template<>
inline auto TestClientConverter::createInvalidInstances<rti1516_202X::fedpro::LogicalTime>() const
{
   rti1516_202X::fedpro::LogicalTime timeWithoutData;
   rti1516_202X::fedpro::LogicalTime timeTooLittleData;
   return std::array<rti1516_202X::fedpro::LogicalTime, 2>{timeWithoutData, timeTooLittleData};
}
