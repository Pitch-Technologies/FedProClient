...
namespace rti1516_202X
{
   ...
   class RTI_EXPORT HLAextendableVariantRecord : public rti1516_202X::DataElement
   {
   public:
   ...
   template<class T> class HLAextendableVariantRecordT : public rti1516_202X::HLAextendableVariantRecord
   {
   public:
      // Constructor
