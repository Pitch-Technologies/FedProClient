...
public interface PersistentSession {
    ...
    * connection alive. May only be set before invoking {@link #start(String, int, Session.HlaCallbackRequestListener)}.
    *
   ...
   void start(String host,
              int port,
              Session.HlaCallbackRequestListener hlaCallbackRequestListener) throws SessionLost, SessionIllegalState;

   /**
    * Start a new Federate Protocol session
    *
    * @param host                       The hosts where the Federate Protocol server is running
    * @param port                       The port of the Federate Protocol server
    ...
    *
    * @param encodedCall the encoded HLA call
    ...
    * @throws SessionIllegalState if the operation is not allowed in this session state
    */
   CompletableFuture<byte[]> sendHlaCallRequest(byte[] encodedCall) throws SessionIllegalState;
