...
public class MessageHeader {
   ...
   private MessageHeader(long packetSize,
                         int sequenceNumber,
                         long sessionId,
   ...
   public static MessageHeader with(long payloadSize,
                                    int sequenceNumber,
                                    long sessionId,
                                    int lastReceivedSequenceNumber,
                                    MessageType messageType)
   ...
   public static MessageHeader decode(InputStream inputStream) throws BadMessage, IOException
   {
