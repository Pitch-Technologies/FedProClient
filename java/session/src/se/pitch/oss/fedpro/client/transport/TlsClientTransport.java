...
public class TlsClientTransport extends ClientTransportBase {
   private static final String SNI_HOST_NAME = System.getProperty("alias");
   private final SSLContext _context;

   public TlsClientTransport(SSLContext context)
   {
      super(Ports.DEFAULT_PORT_TLS);
      _context = context;
   }
                                     ...
                                     int port) throws IOException
   {
      ...
      return new SessionSocketImpl(socket);
   }
}
