...
public class ResumeRequestMessage implements EncodableMessage {
   ...
   public ResumeRequestMessage(int lastReceivedRtiSequenceNumber,
                               int oldestAvailableFederateSequenceNumber)
   {
   ...
   public static ResumeRequestMessage decode(InputStream inputStream) throws IOException
   {
