...
public class HlaCallbackResponseMessage implements EncodableMessage {
   ...
   public HlaCallbackResponseMessage(int responseToSequenceNumber,
                                     byte[] hlaServiceCallbackException)
   {
   ...
   public static HlaCallbackResponseMessage decode(InputStream inputStream,
