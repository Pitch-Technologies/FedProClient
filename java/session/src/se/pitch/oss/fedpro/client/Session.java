...
public interface Session {
    ...
    */
   enum State {
      NEW, STARTING, RUNNING, DROPPED, RESUMING, TERMINATED
   }
    ...
    * Start the session.
    *
    * @param host                       federate protocol server host name
    * @param port                       federate protocol server port
   ...
   void start(String host,
              ...
              TimeUnit startSessionTimeoutUnit) throws SessionLost, SessionIllegalState;
    ...
    */
   boolean resume() throws SessionLost, IOException, SessionIllegalState;
    ...
    */
   CompletableFuture<byte[]> sendHeartbeat() throws SessionIllegalState;
    ...
    */
   CompletableFuture<byte[]> sendHlaCallRequest(byte[] encodedHlaCall) throws SessionIllegalState;
    ...
    */
   void sendHlaCallbackResponse(int responseToSequenceNumber,
    ...
    */
   void terminate() throws SessionLost, SessionIllegalState;
    ...
    *                                  server to respond. The session is still considered terminated when this happens.
    */
   void terminate(int responseTimeout, TimeUnit responseTimeoutUnit) throws SessionLost, SessionIllegalState;
   ...
   interface HlaCallbackRequestListener {
       ...
       */
      void onHlaCallbackRequest(int sequenceNumber,
                                byte[] hlaCallback);
   }

   @FunctionalInterface
   interface StateListener {
      void onStateTransition(State oldState,
                             State newState,
                             String reason);
   }
