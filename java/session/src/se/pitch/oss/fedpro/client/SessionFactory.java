...
public class SessionFactory {
    ...
    */
   public static Session createSession(ClientTransport transport) {
    ...
    */
   public static PersistentSession createPersistentSession(ClientTransport transportProtocol,
                                PersistentSession.ConnectionLostListener connectionLostListener)
   {
      ResumeStrategy strategy = new SimpleResumeStrategy(DEFAULT_RECONNECT_DELAY_MILLIS, DEFAULT_RECONNECT_LIMIT_MILLIS);
