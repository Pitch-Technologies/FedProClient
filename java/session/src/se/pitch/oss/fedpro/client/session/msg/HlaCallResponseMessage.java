...
public class HlaCallResponseMessage implements EncodableMessage {
   ...
   public HlaCallResponseMessage(int responseToSequenceNumber,
                                 byte[] hlaServiceReturnValueOrException)
   {
   ...
   public static HlaCallResponseMessage decode(InputStream inputStream,
