...
public class LogUtil {
   ...
   public static String logPrefix(long sessionId,
                                  String caller)
   {
      return caller + " Session " + padNumString(sessionId == MessageHeader.NO_SESSION_ID ? "-" : String.valueOf(sessionId));
   }
   ...
   public static String padNumString(String nr)
   {
      ...
      for (int i = 0; i < NUMBER_LENGTH - nr.length(); i++) {
         numStr.append(' ');
      }
      numStr.append(nr);
