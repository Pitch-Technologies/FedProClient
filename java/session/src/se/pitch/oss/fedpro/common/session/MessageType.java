...
public enum MessageType {
   //Session Management
   CTRL_NEW_SESSION(1), CTRL_NEW_SESSION_STATUS(2), CTRL_HEARTBEAT(3), CTRL_HEARTBEAT_RESPONSE(4), CTRL_TERMINATE_SESSION(
      5), CTRL_SESSION_TERMINATED(6),

   //Reconnection
   CTRL_RESUME_REQUEST(10), CTRL_RESUME_STATUS(11),

   //HLA Calls and Callbacks
   HLA_CALL_REQUEST(20), HLA_CALL_RESPONSE(21), HLA_CALLBACK_REQUEST(22), HLA_CALLBACK_RESPONSE(23);
