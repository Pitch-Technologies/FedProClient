...
public class TlsContext {
   ...
   public static SSLContext provideSSLContext(TlsKeysImpl tlsKeys,
                                              boolean trustAllServers)
   {
      ...
      TrustManager[] trustManagers = hasTrustedCertificates(keyStore) ? X509ExtendedTrustManagerImpl.create(keyStore,
         trustAllServers,
         false) : null;
   ...
   private static class X509ExtendedKeyManagerImpl extends X509ExtendedKeyManager {
      ...
      public static KeyManager[] create(KeyStore keyStore,
                                        char[] password)
      {
   ...
   private static class X509ExtendedTrustManagerImpl extends X509ExtendedTrustManager {
      ...
      private X509ExtendedTrustManagerImpl(X509ExtendedTrustManager trustManager,
                                           boolean trustAllServers,
      ...
      public static TrustManager[] create(KeyStore keyStore,
                                          boolean trustAllServers,
                                          boolean checkValidity)
      {
         ...
         for (int i = 0; i < trustManagers.length; i++) {
            ...
            if (trustManager instanceof X509ExtendedTrustManager) {
               trustManagers[i] = new X509ExtendedTrustManagerImpl((X509ExtendedTrustManager) trustManager,
                  trustAllServers,
                  checkValidity);
            }
         }
