...
mavenPublishing {
    coordinates("se.pitch.oss.fedpro", "fedpro-client-hla-evolved", libs.versions.fed.pro.client.get())

    publishToMavenCentral()
    signAllPublications()

    pom {
        name.set("Federate Protocol Java Client with HLA Evolved API")
        description.set("Provides the Federate Protocol for HLA Evolved Federates")
