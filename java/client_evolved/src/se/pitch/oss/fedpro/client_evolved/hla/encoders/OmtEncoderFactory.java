...
public class OmtEncoderFactory implements EncoderFactory
{
   ...
   {
      return new OmtHLAvariantRecord<T>(discriminant);
   }
   ...
   public <T extends DataElement> HLAvariableArray<T> createHLAvariableArray(DataElementFactory<T> factory, T... elements)
   {
