...
public class RTIambassadorClientAdapter implements RTIambassador {
   ...
   {
      FomModuleSet fomModuleSet = getFomModuleSet(fomModules);
      _rtiAmbassadorClient.createFederationExecutionWithModules(federationExecutionName, fomModuleSet, logicalTimeImplementationName);
   }
      ...
      RTIinternalError
   {
      try {
         FomModuleSet fomModuleSet = getFomModuleSet(fomModules);
         _rtiAmbassadorClient.createFederationExecutionWithMIM(federationExecutionName, fomModuleSet, getFomModule(mimModule), "HLAfloat64Time");
      ...
      RTIinternalError
   {
      try {
         FomModuleSet fomModuleSet = getFomModuleSet(fomModules);
         _rtiAmbassadorClient.createFederationExecutionWithModules(federationExecutionName, fomModuleSet, "HLAfloat64Time");
      } catch (CouldNotCreateLogicalTimeFactory e) {
         throw new RTIinternalError("Failed to create default time HLAfloat64Time");
      }
   }
   ...
   {
      try {
         _rtiAmbassadorClient.createFederationExecution(federationExecutionName, getFomModule(fomModule), "HLAfloat64Time");
      } catch (CouldNotCreateLogicalTimeFactory e) {
         throw new RTIinternalError("Failed to create default time HLAfloat64Time");
      }
   }
      ...
      RTIinternalError
   {
      ...
      JoinResult joinResult = _rtiAmbassadorClient.joinFederationExecutionWithNameAndModules(federateName, federateType, federationExecutionName, fomModuleSet);
      ...
      RTIinternalError
   {
      checkCallNotAllowedFromWithinCallback();
      FomModuleSet fomModuleSet = getFomModuleSet(additionalFomModules);
      JoinResult joinResult = _rtiAmbassadorClient.joinFederationExecutionWithModules(federateType, federationExecutionName, fomModuleSet);
      FederateHandle federateHandle = joinResult.getFederateHandle();
      String timeFactoryName = joinResult.getLogicalTimeImplementationName();
      _timeFactory = LogicalTimeFactoryFactory.getLogicalTimeFactory(timeFactoryName);
      _clientConverter.setTimeFactory(_timeFactory);
      ...
      RTIinternalError
   {
      ...
      JoinResult joinResult = _rtiAmbassadorClient.joinFederationExecutionWithName(federateName, federateType, federationExecutionName);
      FederateHandle federateHandle = joinResult.getFederateHandle();
      String timeFactoryName = joinResult.getLogicalTimeImplementationName();
      _timeFactory = LogicalTimeFactoryFactory.getLogicalTimeFactory(timeFactoryName);
      _clientConverter.setTimeFactory(_timeFactory);
   ...
   public void registerFederationSynchronizationPoint(String synchronizationPointLabel,
      ...
      RTIinternalError
   {
      _rtiAmbassadorClient.registerFederationSynchronizationPointWithSet(synchronizationPointLabel, userSuppliedTag, synchronizationSet);
   }
      ...
      RTIinternalError
   {
      ...
      _rtiAmbassadorClient.subscribeObjectClassAttributesPassivelyWithRate(theClass, attributeList, updateRateDesignator);
   }
      ...
      RTIinternalError
   {
      ...
      _rtiAmbassadorClient.subscribeObjectClassAttributesWithRegionsAndRate(theClass, attributesAndRegions, true, updateRateDesignator);
   }
      ...
      RTIinternalError
   {
      ...
      _rtiAmbassadorClient.subscribeObjectClassAttributesWithRegionsAndRate(theClass, attributesAndRegions, false, updateRateDesignator);
   }
      ...
      RTIinternalError
   {
      ...
      return _rtiAmbassadorClient.sendInteractionWithRegionsAndTime(theInteraction, theParameters, regions, userSuppliedTag, theTime);
   }
   ...
   {
      checkCallNotAllowedFromWithinCallback();
      return _rtiAmbassadorClient.evokeMultipleCallbacks(approximateMinimumTimeInSeconds, approximateMaximumTimeInSeconds);
   }
