...
public class RTIambassadorClientEvolvedBase extends RTIambassadorClientGenericBase
{
   ...
   public void connect(FederateAmbassador federateReference,
                       ...
                       String localSettingsDesignator) throws
      ConnectionFailed,
      ...
      RTIinternalError
   {
      ...
      synchronized (_connectionStateLock) {
         ...
         hla.rti1516_202X.thin.RtiConfiguration.Builder parsedBuilder = parseLocalSettingsDesignator(splitConfiguration);
         ...
         try {
            ...
            throw new ConnectionFailed(
               "Failed to create session to server " + connectSettings.getServer() + ":" + connectSettings.getPort(),
               e);
         } catch (FedProRtiInternalError e) {
            throw new RTIinternalError(e.getMessage());
         }
   ...
   private hla.rti1516_202X.thin.RtiConfiguration.Builder parseLocalSettingsDesignator(String[] splitConfiguration)
   {
