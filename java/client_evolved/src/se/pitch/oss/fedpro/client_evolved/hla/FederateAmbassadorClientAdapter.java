...
public class FederateAmbassadorClientAdapter {
   ...
   public void discoverObjectInstanceWithProducer(ObjectInstanceHandle theObject,
                                                  ObjectClassHandle theObjectClass,
                                                  String objectName,
   ...
   public void reflectAttributeValues(ObjectInstanceHandle theObject,
      ...
      FederateInternalError
   {
      _federateAmbassador.reflectAttributeValues(theObject, theAttributes, userSuppliedTag, sentOrdering, theTransport, reflectInfo);
   }
   ...
   public void reflectAttributeValuesWithTime(ObjectInstanceHandle theObject,
      ...
      FederateInternalError
   {
      _federateAmbassador.reflectAttributeValues(theObject, theAttributes, userSuppliedTag, sentOrdering, theTransport, theTime, receivedOrdering, reflectInfo);
   }
   ...
   public void reflectAttributeValuesWithRetraction(ObjectInstanceHandle theObject,
      ...
      FederateInternalError
   {
      _federateAmbassador.reflectAttributeValues(theObject, theAttributes, userSuppliedTag, sentOrdering, theTransport, theTime, receivedOrdering, retractionHandle, reflectInfo);
   }
   ...
   public void receiveInteraction(InteractionClassHandle interactionClass,
      ...
      FederateInternalError
   {
      _federateAmbassador.receiveInteraction(interactionClass, theParameters, userSuppliedTag, sentOrdering, theTransport, receiveInfo);
   }
   ...
   public void receiveInteractionWithTime(InteractionClassHandle interactionClass,
      ...
      FederateInternalError
   {
      _federateAmbassador.receiveInteraction(interactionClass, theParameters, userSuppliedTag, sentOrdering, theTransport, theTime, receivedOrdering, receiveInfo);
   }
   ...
   public void receiveInteractionWithRetraction(InteractionClassHandle interactionClass,
      ...
      FederateInternalError
   {
      _federateAmbassador.receiveInteraction(interactionClass, theParameters, userSuppliedTag, sentOrdering, theTransport, theTime, receivedOrdering, retractionHandle, receiveInfo);
   }
   ...
   public void removeObjectInstanceWithTime(ObjectInstanceHandle theObject,
      ...
      FederateInternalError
   {
      _federateAmbassador.removeObjectInstance(theObject, userSuppliedTag, sentOrdering, theTime, receivedOrdering, removeInfo);
   }
   ...
   public void removeObjectInstanceWithRetraction(ObjectInstanceHandle theObject,
      ...
      FederateInternalError
   {
      _federateAmbassador.removeObjectInstance(theObject, userSuppliedTag, sentOrdering, theTime, receivedOrdering, retractionHandle, removeInfo);
   }
