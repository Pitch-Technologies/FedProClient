...
class OmtHLAmessageRetractionHandle extends AbstractDataElement implements HLAmessageRetractionHandle {
   ...
   public HLAmessageRetractionHandle decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(4);
   ...
   @Override
   public HLAmessageRetractionHandle decode(byte[] bytes) throws DecoderException
   {
