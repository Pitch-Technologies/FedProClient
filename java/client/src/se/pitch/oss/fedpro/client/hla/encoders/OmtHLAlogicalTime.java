...
class OmtHLAlogicalTime<T extends LogicalTime<T, U>, U extends LogicalTimeInterval<U>> extends AbstractDataElement implements HLAlogicalTime<T, U> {
   ...
   public OmtHLAlogicalTime<T, U> decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(4);
   ...
   @Override
   public HLAlogicalTime<T, U> decode(byte[] bytes) throws DecoderException
   {
