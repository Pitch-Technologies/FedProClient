...
public class OmtEncoderFactory implements EncoderFactory {
   ...
   public <T extends DataElement> HLAfixedArray<T> createHLAfixedArray(DataElementFactory<T> factory,
                                                                       int size)
   {
      return new OmtHLAfixedArray<T>(factory, size);
   }

   public <T extends DataElement> HLAfixedArray<T> createHLAfixedArray(T... elements)
   {
      return new OmtHLAfixedArray<T>(elements);
   }
   ...
   public <T extends DataElement> HLAvariableArray<T> createHLAvariableArray(DataElementFactory<T> factory,
                                                                             T... elements)
   {
      return new OmtHLAvariableArray<T>(factory, elements);
   }
   ...
   @Override
   public <T extends LogicalTime<T, U>, U extends LogicalTimeInterval<U>> HLAlogicalTime<T, U> createHLAlogicalTime(RTIambassador rtiAmbassador)
   {
      return new OmtHLAlogicalTime<T, U>(rtiAmbassador);
   }
   ...
   public <T extends LogicalTime<T, U>, U extends LogicalTimeInterval<U>> HLAlogicalTime<T, U> createHLAlogicalTime(RTIambassador rtiAmbassador,
                                                                                                                    T logicalTime)
   {
      return new OmtHLAlogicalTime<T, U>(rtiAmbassador, logicalTime);
   }

   @Override
   public <T extends LogicalTime<T, U>, U extends LogicalTimeInterval<U>> HLAlogicalTimeInterval<T, U> createHLAlogicalTimeInterval(RTIambassador rtiAmbassador)
   {
      return new OmtHLAlogicalTimeInterval<T, U>(rtiAmbassador);
   }
   ...
   {
      return new OmtHLAlogicalTimeInterval<T, U>(rtiAmbassador, logicalTimeInterval);
   }
}
