...
class OmtHLAvariantRecord<T extends DataElement> extends AbstractDataElement implements HLAvariantRecord<T> {
   ...
   public OmtHLAvariantRecord<T> setVariant(T discriminant,
   ...
   public OmtHLAvariantRecord<T> decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
   ...
   @Override
   public HLAvariantRecord<T> decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
