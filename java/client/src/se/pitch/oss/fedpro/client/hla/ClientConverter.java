...
public class ClientConverter {
   ...
   ConfigurationResult convertToHla(hla.rti1516_202X.thin.ConfigurationResult configurationResult)
   {
      boolean configurationUsed = configurationResult.getConfigurationUsed();
      boolean addressUsed = configurationResult.getAddressUsed();
      hla.rti1516_202X.thin.AdditionalSettingsResultCode additionalSettingsResultCode = configurationResult.getAdditionalSettingsResultCode();
      String message = configurationResult.getMessage();
      return new ConfigurationResult(configurationUsed,
         addressUsed,
         convertToHla(additionalSettingsResultCode),
         message);
   }

   hla.rti1516_202X.thin.RtiConfiguration.Builder convertFromHla(RtiConfiguration rtiConfiguration)
   {
   ...
   private static class FederateHandleImpl extends HandleImpl implements FederateHandle {
      ...
      public FederateHandleImpl(byte[] buffer,
                                int offset)
      {
         super(buffer, offset);
      }
   ...
   static class ConveyedRegionHandleImpl implements RegionHandle {
      ...
      void addRange(DimensionHandle dimensionHandle,
                    long lower,
                    long upper)
      {
   ...
   private static class ObjectClassHandleImpl extends HandleImpl implements ObjectClassHandle {
      ...
      public ObjectClassHandleImpl(byte[] buffer,
                                   int offset)
      {
         super(buffer, offset);
      }
   ...
   private static class ObjectInstanceHandleImpl extends HandleImpl implements ObjectInstanceHandle {
      ...
      public ObjectInstanceHandleImpl(byte[] buffer,
                                      int offset)
      {
         super(buffer, offset);
      }
   ...
   private static class InteractionClassHandleImpl extends HandleImpl implements InteractionClassHandle {
      ...
      public InteractionClassHandleImpl(byte[] buffer,
                                        int offset)
      {
         super(buffer, offset);
      }
   ...
   static class ParameterHandleImpl extends HandleImpl implements ParameterHandle {
      ...
      public ParameterHandleImpl(byte[] buffer,
                                 int offset)
      {
         super(buffer, offset);
      }
   ...
   private static class TransportationTypeHandleImpl extends HandleImpl implements TransportationTypeHandle {
      ...
      private static final long serialVersionUID = 799087519655919037L;
      ...
      private TransportationTypeHandleImpl(byte[] buffer,
                                          int offset)
      {
         super(buffer, offset);
      }
   ...
   public JoinResult convertToHla(hla.rti1516_202X.thin.JoinResult result)
   {
      ...
      return new JoinResult(convertToHla(result.getFederateHandle()),
   ...
   public hla.rti1516_202X.thin.InteractionClassHandle convertFromHla(InteractionClassHandle result)
   {
   ...
   public hla.rti1516_202X.thin.ObjectClassHandle convertFromHla(ObjectClassHandle result)
   {
   ...
   public hla.rti1516_202X.thin.ObjectInstanceHandle convertFromHla(ObjectInstanceHandle result)
   {
   ...
   public hla.rti1516_202X.thin.AttributeHandleSet convertFromHla(AttributeHandleSet result) throws AttributeNotDefined
   {
      if (result == null) {
   ...
   public hla.rti1516_202X.thin.MessageRetractionReturn convertFromHla(MessageRetractionReturn result)
   {
      ...
      hla.rti1516_202X.thin.MessageRetractionReturn.Builder builder = hla.rti1516_202X.thin.MessageRetractionReturn.newBuilder();
   ...
   public hla.rti1516_202X.thin.TransportationTypeHandle convertFromHla(TransportationTypeHandle result)
   {
   ...
   public hla.rti1516_202X.thin.LogicalTime convertFromHla(hla.rti1516_202X.LogicalTime<?, ?> logicalTime)
   ...
   public hla.rti1516_202X.thin.LogicalTimeInterval convertFromHla(hla.rti1516_202X.LogicalTimeInterval<?> logicalTimeInterval)
      throws RTIinternalError
   {
   ...
   public InteractionClassHandle convertToHla(hla.rti1516_202X.thin.InteractionClassHandle theInteraction)
   {
      return new InteractionClassHandleImpl(theInteraction.getData().toByteArray());
   }

   public ObjectClassHandle convertToHla(hla.rti1516_202X.thin.ObjectClassHandle objectClassHandle)
   {
   ...
   public ObjectInstanceHandle convertToHla(hla.rti1516_202X.thin.ObjectInstanceHandle objectInstanceHandle)
   {
   ...
   public InteractionClassHandleSet convertToHla(hla.rti1516_202X.thin.InteractionClassHandleSet interactionClassHandleSet)
   {
      InteractionClassHandleSet handleSet = getInteractionClassHandleSetFactory().create();
      for (hla.rti1516_202X.thin.InteractionClassHandle interactionClassHandle : interactionClassHandleSet.getInteractionClassHandleList()) {
   ...
   public RegionHandleSet convertToHla(hla.rti1516_202X.thin.RegionHandleSet regionHandleSet) throws RTIinternalError
   {
      try {
   ...
   public AttributeHandleValueMap convertToHla(hla.rti1516_202X.thin.AttributeHandleValueMap attributeHandleValueMap)
   {
      ...
      for (AttributeHandleValue attributeHandleValue : attributeHandleValueMap.getAttributeHandleValueList()) {
         result.put(convertToHla(attributeHandleValue.getAttributeHandle()),
      ...
      throws RTIinternalError
   {
      try {
         ...
         for (hla.rti1516_202X.thin.ParameterHandleValue ParameterHandleValue : parameterHandleValueMap.getParameterHandleValueList()) {
            result.put(convertToHla(ParameterHandleValue.getParameterHandle()),
   ...
   public TransportationTypeHandle convertToHla(hla.rti1516_202X.thin.TransportationTypeHandle transportationTypeHandle)
      throws RTIinternalError
   {
      try {
   ...
   public hla.rti1516_202X.LogicalTime<?, ?> convertToHla(hla.rti1516_202X.thin.LogicalTime logicalTime)
      throws RTIinternalError
   {
      try {
   ...
   public hla.rti1516_202X.LogicalTimeInterval<?> convertToHla(hla.rti1516_202X.thin.LogicalTimeInterval logicalTimeInterval)
      throws RTIinternalError
   {
      try {
   ...
   public hla.rti1516_202X.thin.ResignAction convertFromHla(ResignAction resignAction)
   {
   ...
   public hla.rti1516_202X.thin.InteractionClassHandleSet convertFromHla(InteractionClassHandleSet interactionClassHandleSet)
   {
      Objects.requireNonNull(interactionClassHandleSet, "interactionClassHandleSet must not be null");
      hla.rti1516_202X.thin.InteractionClassHandleSet.Builder builder = hla.rti1516_202X.thin.InteractionClassHandleSet.newBuilder();
   ...
   public TimeQueryReturn convertToHla(hla.rti1516_202X.thin.TimeQueryReturn result) throws RTIinternalError
   {
      return new TimeQueryReturn(result.getLogicalTimeIsValid(),
   ...
   public hla.rti1516_202X.thin.DimensionHandleSet convertFromHla(DimensionHandleSet dimensions)
   ...
   public hla.rti1516_202X.thin.RegionHandleSet convertFromHla(RegionHandleSet regions) throws InvalidRegion
   {
      if (regions == null) {
   ...
   public hla.rti1516_202X.thin.AttributeSetRegionSetPairList convertFromHla(AttributeSetRegionSetPairList attributesAndRegions)
   ...
   public hla.rti1516_202X.thin.ServiceGroup convertFromHla(ServiceGroup group) throws InvalidServiceGroup
   {
      if (group == null) {
   ...
   public RangeBounds convertToHla(hla.rti1516_202X.thin.RangeBounds result)
   {
      return new RangeBounds(Integer.toUnsignedLong(result.getLower()), Integer.toUnsignedLong(result.getUpper()));
   }

   public hla.rti1516_202X.thin.RangeBounds convertFromHla(RangeBounds bounds) throws InvalidRangeBound
   {
      if (bounds == null) {
   ...
   {
      return new SupplementalReceiveInfoImpl(convertToHla(receiveInfo.getProducingFederate()),
   ...
   private static class SupplementalReceiveInfoImpl implements FederateAmbassador.SupplementalReceiveInfo {
      ...
      public SupplementalReceiveInfoImpl(FederateHandle producingFederate,
   ...
   {
      return new SupplementalReflectInfoImpl(convertToHla(reflectInfo.getConveyedRegions()),
   ...
   public FederateRestoreStatus[] convertToHla(FederateRestoreStatusArray federateRestoreStatusArray)
   {
      ...
      for (hla.rti1516_202X.thin.FederateRestoreStatus federateRestoreStatus : federateRestoreStatusArray.getFederateRestoreStatusList()) {
         federateRestoreStatuses[i] = new FederateRestoreStatus(convertToHla(federateRestoreStatus.getPreRestoreHandle()),
   ...
   public FederateHandleSaveStatusPair[] convertToHla(FederateHandleSaveStatusPairArray federateHandleSaveStatusPairArray)
   {
      ...
      for (hla.rti1516_202X.thin.FederateHandleSaveStatusPair saveStatusPair : federateHandleSaveStatusPairArray.getFederateHandleSaveStatusPairList()) {
         federateHandleSaveStatusPairs[i] = new FederateHandleSaveStatusPair(convertToHla(saveStatusPair.getFederateHandle()),
   ...
   public AdditionalSettingsResultCode convertToHla(hla.rti1516_202X.thin.AdditionalSettingsResultCode additionalSettingsResultCode)
   {
   ...
   private static class SupplementalReflectInfoImpl implements FederateAmbassador.SupplementalReflectInfo {
      ...
      public SupplementalReflectInfoImpl(RegionHandleSet sentRegions,
   ...
   {
      return new FederationExecutionInformation(info.getFederationExecutionName(),
   ...
   private FederationExecutionMemberInformation convertToHla(hla.rti1516_202X.thin.FederationExecutionMemberInformation info)
   {
   ...
   public FederationExecutionMemberInformationSet convertToHla(hla.rti1516_202X.thin.FederationExecutionMemberInformationSet federationExecutionMemberInformationSet)
   {
      FederationExecutionMemberInformationSet informationSet = new FederationExecutionMemberInformationSetImpl();
      for (hla.rti1516_202X.thin.FederationExecutionMemberInformation info : federationExecutionMemberInformationSet.getFederationExecutionMemberInformationList()) {
         informationSet.add(convertToHla(info));
      }
      return informationSet;
   }
   ...
   private static class MyTransportationTypeHandleFactory implements TransportationTypeHandleFactory {
      ...
      private static final long serialVersionUID = -4205845846852298228L;
   ...
   private static class MyMessageRetractionHandleFactory implements MessageRetractionHandleFactory {
      @Override
      public MessageRetractionHandle decode(byte[] buffer,
                                            int offset)
   ...
   private static class MyRegionHandleFactory implements RegionHandleFactory {
      @Override
      public RegionHandle decode(byte[] buffer,
                                 int offset)
         throws CouldNotDecode, FederateNotExecutionMember, NotConnected, RTIinternalError
      {
         if (buffer.length - offset == 0) {
