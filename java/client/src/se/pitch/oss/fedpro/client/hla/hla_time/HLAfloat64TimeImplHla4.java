...
public class HLAfloat64TimeImplHla4 implements HLAfloat64Time {
   private static final double INITIAL_VALUE = 0;
   private static final double FINAL_VALUE = Double.MAX_VALUE;

   static final HLAfloat64Time INITIAL = new HLAfloat64TimeImplHla4(INITIAL_VALUE);
   static final HLAfloat64Time FINAL = new HLAfloat64TimeImplHla4(FINAL_VALUE);

   private final double _value;

   public HLAfloat64TimeImplHla4()
   {
      _value = INITIAL_VALUE;
   }

   public HLAfloat64TimeImplHla4(double value)
   {
      _value = value;
   }

   public HLAfloat64TimeImplHla4(byte[] buffer,
                                 int offset) throws CouldNotDecode
   {
      ...
      try {
         ...
         throw new CouldNotDecode("Unable to decode HLAfloat64Time (909001001): " + e);
   ...
   {
      return new HLAfloat64IntervalImplHla4(Math.abs(_value - val.getValue()));
   }
