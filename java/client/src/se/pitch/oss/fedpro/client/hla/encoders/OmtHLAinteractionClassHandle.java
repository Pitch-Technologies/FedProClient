...
class OmtHLAinteractionClassHandle extends AbstractDataElement implements HLAinteractionClassHandle {
   ...
   public OmtHLAinteractionClassHandle decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(4);
   ...
   @Override
   public HLAinteractionClassHandle decode(byte[] bytes) throws DecoderException
   {
