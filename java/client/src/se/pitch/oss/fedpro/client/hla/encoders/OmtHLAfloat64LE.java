...
import hla.rti1516_202X.encoding.HLAfloat64LE;
...
class OmtHLAfloat64LE extends AbstractDataElement implements HLAfloat64LE {
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public OmtHLAfloat64LE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         long longBits = 0L;
   ...
   @Override
   public HLAfloat64LE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
