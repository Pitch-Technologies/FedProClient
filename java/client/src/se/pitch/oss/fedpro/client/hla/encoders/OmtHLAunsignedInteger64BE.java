...
import hla.rti1516_202X.encoding.HLAunsignedInteger64BE;

class OmtHLAunsignedInteger64BE extends AbstractDataElement implements HLAunsignedInteger64BE {
   private long _value;

   OmtHLAunsignedInteger64BE()
   {
      _value = 0L;
   }

   OmtHLAunsignedInteger64BE(long value)
   {
      _value = value;
   }
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public HLAunsignedInteger64BE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         long value = 0L;
   ...
   @Override
   public HLAunsignedInteger64BE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
   ...
   public HLAunsignedInteger64BE setValue(long value)
   {
      _value = value;
      return this;
   }
   ...
   public boolean equals(Object o)
   {
      ...
      if (!(o instanceof OmtHLAunsignedInteger64BE)) {
         return false;
      }

      final OmtHLAunsignedInteger64BE other = (OmtHLAunsignedInteger64BE) o;
