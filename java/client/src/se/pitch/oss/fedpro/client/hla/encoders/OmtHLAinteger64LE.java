...
import hla.rti1516_202X.encoding.HLAinteger64LE;

import static java.lang.Long.valueOf;

class OmtHLAinteger64LE extends AbstractDataElement implements HLAinteger64LE {
   private long _value;
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public OmtHLAinteger64LE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         long value = 0L;
   ...
   @Override
   public HLAinteger64LE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
