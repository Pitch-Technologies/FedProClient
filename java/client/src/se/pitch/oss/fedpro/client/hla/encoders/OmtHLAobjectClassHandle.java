...
class OmtHLAobjectClassHandle extends AbstractDataElement implements HLAobjectClassHandle {
   ...
   public OmtHLAobjectClassHandle decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(4);
   ...
   @Override
   public HLAobjectClassHandle decode(byte[] bytes) throws DecoderException
   {
