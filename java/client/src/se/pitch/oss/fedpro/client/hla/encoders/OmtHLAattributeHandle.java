...
class OmtHLAattributeHandle extends AbstractDataElement implements HLAattributeHandle {
   ...
   public OmtHLAattributeHandle decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(4);
   ...
   @Override
   public HLAattributeHandle decode(byte[] bytes) throws DecoderException
   {
