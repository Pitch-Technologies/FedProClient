...
class OmtHLAunsignedInteger16BE extends AbstractDataElement implements HLAunsignedInteger16BE {
   ...
   OmtHLAunsignedInteger16BE(short value)
   {
      _value = value;
   }

   OmtHLAunsignedInteger16BE()
   {
      _value = 0;
   }
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public final HLAunsignedInteger16BE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         short value = 0;
   ...
   @Override
   public HLAunsignedInteger16BE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
   ...
   public HLAunsignedInteger16BE setValue(short value)
   {
      _value = value;
      return this;
   }
   ...
   public boolean equals(Object o)
   {
      ...
      if (!(o instanceof OmtHLAunsignedInteger16BE)) {
         return false;
      }

      final OmtHLAunsignedInteger16BE omtHLAinteger16BE = (OmtHLAunsignedInteger16BE) o;
