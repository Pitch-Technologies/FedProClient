...
class OmtHLAunsignedInteger32LE extends AbstractDataElement implements HLAunsignedInteger32LE {
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public HLAunsignedInteger32LE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         int value = 0;
   ...
   @Override
   public HLAunsignedInteger32LE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
