...
import hla.rti1516_202X.encoding.HLAinteger32LE;
...
class OmtHLAinteger32LE extends AbstractDataElement implements HLAinteger32LE {
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public OmtHLAinteger32LE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         int value = 0;
   ...
   @Override
   public HLAinteger32LE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
