...
class OmtHLAunsignedInteger16LE extends AbstractDataElement implements HLAunsignedInteger16LE {
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public final HLAunsignedInteger16LE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         short value = 0;
   ...
   @Override
   public HLAunsignedInteger16LE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
