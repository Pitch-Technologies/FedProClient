...
import hla.rti1516_202X.encoding.HLAinteger16LE;

class OmtHLAinteger16LE extends AbstractDataElement implements HLAinteger16LE {
   private short _value;

   OmtHLAinteger16LE(short value)
   {
      _value = value;
   }
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public final OmtHLAinteger16LE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         short value = 0;
   ...
   @Override
   public HLAinteger16LE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
