...
public class HLAfloat64IntervalImplHla4 implements HLAfloat64Interval {
   private static final double ZERO_VALUE = 0;
   private static final double EPSILON_VALUE = Double.MIN_VALUE;

   static final HLAfloat64Interval ZERO = new HLAfloat64IntervalImplHla4(ZERO_VALUE);
   static final HLAfloat64Interval EPSILON = new HLAfloat64IntervalImplHla4(EPSILON_VALUE);


   private final double _value;

   public HLAfloat64IntervalImplHla4()
   {
      _value = ZERO_VALUE;
   }

   public HLAfloat64IntervalImplHla4(double value)
   {
      _value = value;
   }

   public HLAfloat64IntervalImplHla4(byte[] buffer,
                                     int offset) throws CouldNotDecode
   {
      ...
      try {
         ...
         throw new CouldNotDecode("Unable to decode HLAfloat64Interval (909001001): " + e);
   ...
   public HLAfloat64Interval add(HLAfloat64Interval addend) throws IllegalTimeArithmetic
   {
   ...
   public HLAfloat64Interval subtract(HLAfloat64Interval subtrahend) throws IllegalTimeArithmetic
   {
