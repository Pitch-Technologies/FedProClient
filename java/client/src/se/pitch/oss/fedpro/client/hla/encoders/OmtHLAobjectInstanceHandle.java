...
class OmtHLAobjectInstanceHandle extends AbstractDataElement implements HLAobjectInstanceHandle {
   ...
   public OmtHLAobjectInstanceHandle decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(4);
   ...
   @Override
   public HLAobjectInstanceHandle decode(byte[] bytes) throws DecoderException
   {
