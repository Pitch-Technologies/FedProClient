...
import hla.rti1516_202X.encoding.HLAinteger32BE;
...
class OmtHLAinteger32BE extends AbstractDataElement implements HLAinteger32BE {
   ...
   public HLAinteger32BE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
   ...
   @Override
   public HLAinteger32BE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
