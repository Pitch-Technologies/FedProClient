...
public class HLAinteger64IntervalImplHla4 implements HLAinteger64Interval {
   private static final long ZERO_VALUE = 0;
   private static final long EPSILON_VALUE = 1;

   static final HLAinteger64Interval ZERO = new HLAinteger64IntervalImplHla4(ZERO_VALUE);
   static final HLAinteger64Interval EPSILON = new HLAinteger64IntervalImplHla4(EPSILON_VALUE);

   private final long _value;

   public HLAinteger64IntervalImplHla4()
   {
      _value = ZERO_VALUE;
   }

   public HLAinteger64IntervalImplHla4(long value)
   {
      _value = value;
   }

   public HLAinteger64IntervalImplHla4(byte[] buffer,
                                       int offset) throws CouldNotDecode
   {
      ...
      try {
         ...
         throw new CouldNotDecode("Unable to decode HLAinteger64Interval (909001001): " + e);
   ...
   public HLAinteger64Interval add(HLAinteger64Interval addend) throws IllegalTimeArithmetic
   {
      long lhs = _value;
      ...
      return new HLAinteger64IntervalImplHla4(lhs + rhs);
   }

   public HLAinteger64Interval subtract(HLAinteger64Interval subtrahend) throws IllegalTimeArithmetic
   {
      long lhs = _value;
   ...
   {
      return Long.valueOf(_value).compareTo(other.getValue());
   }
   ...
   public void encode(byte[] buffer,
                      int offset) throws CouldNotEncode
   {
      if (buffer == null) {
