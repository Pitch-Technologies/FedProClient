...
*/
   ...
   public static void doThrow(String exceptionName,
                              String details) throws FedProRtiInternalError
   {
   ...
   public static RTIexception createException(String exceptionName,
                                              String details)
   {
      Constructor<? extends RTIexception> constructor = Init.CONSTRUCTORS.get(exceptionName);
      if (constructor != null) {
