...
class OmtHLAunsignedInteger32BE extends AbstractDataElement implements HLAunsignedInteger32BE {
   ...
   public HLAunsignedInteger32BE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
   ...
   @Override
   public HLAunsignedInteger32BE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
