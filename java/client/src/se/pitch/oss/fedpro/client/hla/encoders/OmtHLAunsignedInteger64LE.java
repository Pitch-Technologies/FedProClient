...
class OmtHLAunsignedInteger64LE extends AbstractDataElement implements HLAunsignedInteger64LE {
    ...
    * @noinspection PointlessBitwiseExpression
    */
   public HLAunsignedInteger64LE decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
         long value = 0L;
   ...
   @Override
   public HLAunsignedInteger64LE decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
