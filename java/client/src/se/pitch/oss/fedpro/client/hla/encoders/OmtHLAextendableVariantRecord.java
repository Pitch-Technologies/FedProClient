...
class OmtHLAextendableVariantRecord<T extends DataElement> extends AbstractDataElement implements HLAextendableVariantRecord<T> {
   ...
   public OmtHLAextendableVariantRecord<T> setVariant(T discriminant,
   ...
   public DataElement getValue() throws EncoderException
   {
   ...
   public OmtHLAextendableVariantRecord<T> decode(ByteWrapper byteWrapper) throws DecoderException
   {
      try {
         byteWrapper.align(getOctetBoundary());
   ...
   @Override
   public HLAextendableVariantRecord<T> decode(byte[] bytes) throws DecoderException
   {
      super.decode(bytes);
      return this;
   }
   ...
   public boolean equals(Object o)
   {
      ...
      if (_activeDiscriminant != null && !Objects.equals(_variantMap.get(_activeDiscriminant),
