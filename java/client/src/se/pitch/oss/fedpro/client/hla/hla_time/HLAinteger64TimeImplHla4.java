...
public class HLAinteger64TimeImplHla4 implements HLAinteger64Time {
   private static final long INITIAL_VALUE = 0;
   private static final long FINAL_VALUE = Long.MAX_VALUE;

   static final HLAinteger64Time INITIAL = new HLAinteger64TimeImplHla4(INITIAL_VALUE);
   static final HLAinteger64Time FINAL = new HLAinteger64TimeImplHla4(FINAL_VALUE);

   private final long _value;

   public HLAinteger64TimeImplHla4()
   {
      _value = INITIAL_VALUE;
   }

   public HLAinteger64TimeImplHla4(long value)
   {
      _value = value;
   }

   public HLAinteger64TimeImplHla4(byte[] buffer,
                                   int offset) throws CouldNotDecode
   {
      ...
      try {
         ...
         throw new CouldNotDecode("Unable to decode HLAinteger64Time (909001001): " + e);
   ...
   public HLAinteger64Time add(HLAinteger64Interval val) throws IllegalTimeArithmetic
   {
      ...
      return new HLAinteger64TimeImplHla4(lhs + rhs);
   }
   ...
   {
      return new HLAinteger64IntervalImplHla4(Math.abs(_value - val.getValue()));
   }
