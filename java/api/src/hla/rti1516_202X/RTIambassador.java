...
////////////////////////////////////
   ...
   // 4.2
   ConfigurationResult connect(FederateAmbassador federateReference,
   ...
   // 4.10
   void listFederationExecutionMembers(String federationExecutionName)
      throws
      NotConnected,
      RTIinternalError;
...
/////////////////////////////////////
   ...
   void publishObjectClassDirectedInteractions(ObjectClassHandle theClass,
                                               InteractionClassHandleSet interactionList)
      throws
   ...
   // 5.3
   void unpublishObjectClassDirectedInteractions(ObjectClassHandle theClass)
      throws
      ObjectClassNotDefined,
      SaveInProgress,
      RestoreInProgress,
   ...
   // 5.6
   void subscribeObjectClassDirectedInteractions(ObjectClassHandle theClass,
                                                 InteractionClassHandleSet interactionList)
      throws
      InteractionClassNotDefined,
      ObjectClassNotDefined,
   ...
   // 5.7
   void unsubscribeObjectClassDirectedInteractions(ObjectClassHandle theClass)
      throws
      ObjectClassNotDefined,
      SaveInProgress,
      RestoreInProgress,
...
////////////////////////////////
   ...
   void sendDirectedInteraction(InteractionClassHandle theInteraction,
   ...
   // 6.12
   MessageRetractionReturn sendDirectedInteraction(InteractionClassHandle theInteraction,
                                                   ObjectInstanceHandle theObject,
                                                   ParameterHandleValueMap theParameters,
                                                   byte[] userSuppliedTag,
                                                   LogicalTime<?, ?> theTime)
   ...
   // 6.25
   void changeDefaultAttributeTransportationType(ObjectClassHandle theObjectClass,
                                                 AttributeHandleSet theAttributes,
                                                 TransportationTypeHandle theType)
      throws
      AttributeAlreadyBeingChanged,
...
//////////////////////////////
   ...
   // 8.25
   void changeDefaultAttributeOrderType(ObjectClassHandle theObjectClass,
                                        AttributeHandleSet theAttributes,
                                        OrderType theType)
      throws
      AttributeNotDefined,
...
//////////////////////////
   ...
   // 10.33
   long normalizeObjectClassHandle(ObjectClassHandle objectClassHandle)
      throws
      InvalidObjectClassHandle,
      FederateNotExecutionMember,
      NotConnected,
   ...
   // 10.34
   long normalizeInteractionClassHandle(InteractionClassHandle interactionClassHandle)
      throws
      InvalidInteractionClassHandle,
      FederateNotExecutionMember,
      NotConnected,
   ...
   // 10.35
   long normalizeObjectInstanceHandle(ObjectInstanceHandle objectInstanceHandle)
      throws
