...
/**
 * Interface for the HLA data type HLAfederateHandle.
 */
public interface HLAfederateHandle extends DataElement {
    ...
    */
   HLAfederateHandle setValue(FederateHandle value);
    ...
    */
   @Override
   HLAfederateHandle decode(ByteWrapper byteWrapper)
      throws
      DecoderException;
    ...
    */
   @Override
   HLAfederateHandle decode(byte[] bytes)
      throws
      DecoderException;
}
